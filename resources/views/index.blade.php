...
<div class="body">
    ...
    <div role="main" class="main">
				...
				<section class="section section-no-border section-dark section-angled section-angled-reverse pt-5 m-0" style="background-image: url(img/landing/header_bg.jpg); background-size: cover; background-position: center; animation-duration: 750ms; animation-delay: 300ms; animation-fill-mode: forwards; min-height: 645px;">
					<div class="section-angled-layer-bottom section-angled-layer-increase-angle bg-light" style="padding: 8rem 0;"></div>
					<div class="container pt-lg-5 mt-5">
						<div class="row pt-3 pb-lg-0 pb-xl-0">
							<div class="col-lg-6 pt-4 mb-5 mb-lg-0">
                                <div id="id71bbfd9011d79" a='{"t":"s","v":"1.2","lang":"id","locs":[],"ssot":"c","sics":"ds","cbkg":"#FFFFFF00","cfnt":"rgba(255,255,255,1)","slfs":"33","slis":"45","slgp":"14","sfnt":"a","sdr":"lr"}'><a href="https://cuacalab.id/widget/">Weather widget html for website by cuacalab.id</a></div><script async src="https://static1.cuacalab.id/widgetjs/?id=id71bbfd9011d79"></script>
								<h1 class="font-weight-bold text-10 text-xl-12 line-height-2 mb-3">Call to Action</h1>
								<p class="font-weight-light opacity-7 pb-2 mb-4">Tons of call to action types to highlight informations and direct your website users.</p>
					...
					<div class="container">
						<div class="row">
							<div class="col text-center">
								<h2 class="font-weight-bold text-color-light mb-2">We’re excited Build This Daily Project</h2>
								<p class="text-color-light opacity-7">Because</p>
							</div>
						</div>
						<div class="row">
							<div class="col">
								...
								<div class="owl-carousel owl-theme nav-bottom rounded-nav mb-0" data-plugin-options="{'items': 1, 'loop': true, 'autoHeight': true}">
									<div>
										<div class="testimonial testimonial-style-2 testimonial-light testimonial-with-quotes testimonial-quotes-primary mb-0">
											<blockquote>
												<p class="text-5 line-height-5 mb-0">it's useless to have many quotes, but don't want to change yourself</p>
											</blockquote>
											<div class="testimonial-author">
												<p><strong class="font-weight-extra-bold text-2">- Adityo Prayoga</strong></p>
											</div>
										</div>
									</div>
									<div>
										<div class="testimonial testimonial-style-2 testimonial-light testimonial-with-quotes testimonial-quotes-primary mb-0">
											<blockquote>
												<p class="text-5 line-height-5 mb-0">The greatest glory in living lies not in never falling, but in rising every time we fall.</p>
											</blockquote>
											<div class="testimonial-author">
												<p><strong class="font-weight-extra-bold text-2">- Nelson Mandela</strong></p>
											</div>
										</div>
									</div>
									<div>
										<div class="testimonial testimonial-style-2 testimonial-light testimonial-with-quotes testimonial-quotes-primary mb-0">
											<blockquote>
												<p class="text-5 line-height-5 mb-0">Success is not final, failure is not fatal: It is the courage to continue that counts</p>
											</blockquote>
											<div class="testimonial-author">
												<p><strong class="font-weight-extra-bold text-2">- Winston Churchill</strong></p>
											</div>
										</div>
									</div>
								</div>
            ...
            <div class="container pt-5 mt-5">
                <div class="row align-items-center pt-3">
                    <div class="col-lg-5 mb-5">
                        ...
                        <h1 class="font-weight-bold text-12 line-height-2 mb-3">The Best HTML5 Template<span><span class="d-inline-block text-primary highlighted-word highlighted-word-rotate highlighted-word-animation-1 highlighted-word-animation-1-no-animate alternative-font-3 font-weight-bold text-1 ms-2">ever</span></span></h1>
                        <p class="custom-font-size-1">Porto is simply the best choice for your new website. The template is several years among the most popular in the world. <a href="#intro" data-hash data-hash-offset="0" data-hash-offset-lg="120" class="text-color-light font-weight-semibold text-1 d-block text-decoration-none">VIEW MORE <i class="fa fa-long-arrow-alt-right ms-1"></i></a></p>
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5 custom-header-bar position-relative py-4 pe-5 z-index-2">
                        <div>
                            ...
                            <p class="position-relative text-center font-weight-normal mb-1">* Approved by 40k buyers since 2013</p>
                        </div>
                    </div>
                </div>
            </div>
